...
@class SharedChatMessage, SharedConstants, SharedKotlinByteArray, SharedEncounterCompanion, SharedEncounter, SharedEncounterBus, SharedFakeServer, SharedUser, SharedResolvedEncounter, SharedUserCompanion, SharedUserResolver, SharedKotlinByteIterator, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreFlow, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
- (instancetype)initWithText:(NSString *)text isIncoming:(BOOL)isIncoming __attribute__((swift_name("init(text:isIncoming:)"))) __attribute__((objc_designated_initializer));
- (SharedChatMessage *)doCopyText:(NSString *)text isIncoming:(BOOL)isIncoming __attribute__((swift_name("doCopy(text:isIncoming:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL isIncoming __attribute__((swift_name("isIncoming")));
...
@property (readonly) int64_t ROTATION_SECONDS __attribute__((swift_name("ROTATION_SECONDS")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CryptographyManager")))
@interface SharedCryptographyManager : SharedBase
- (instancetype)initWithSharedSecret:(SharedKotlinByteArray *)sharedSecret __attribute__((swift_name("init(sharedSecret:)"))) __attribute__((objc_designated_initializer));
- (SharedKotlinByteArray *)encryptRotatingIdentifierPersonalIdHex:(NSString *)personalIdHex timestamp:(int64_t)timestamp __attribute__((swift_name("encryptRotatingIdentifier(personalIdHex:timestamp:)")));
@end
...
@interface SharedEncounter : SharedBase
- (instancetype)initWithIdHex:(NSString *)idHex rssi:(int32_t)rssi timestampSec:(int64_t)timestampSec resolvedName:(NSString * _Nullable)resolvedName __attribute__((swift_name("init(idHex:rssi:timestampSec:resolvedName:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedEncounterCompanion *companion __attribute__((swift_name("companion")));
- (SharedEncounter *)doCopyIdHex:(NSString *)idHex rssi:(int32_t)rssi timestampSec:(int64_t)timestampSec resolvedName:(NSString * _Nullable)resolvedName __attribute__((swift_name("doCopy(idHex:rssi:timestampSec:resolvedName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *idHex __attribute__((swift_name("idHex")));
@property (readonly) NSString * _Nullable resolvedName __attribute__((swift_name("resolvedName")));
...
@interface SharedEncounterCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedEncounterCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EncounterBus")))
@interface SharedEncounterBus : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)encounterBus __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedEncounterBus *shared __attribute__((swift_name("shared")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)emitEncounter:(SharedEncounter *)encounter completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("emit(encounter:completionHandler:)")));
@property (readonly) id<SharedKotlinx_coroutines_coreSharedFlow> events __attribute__((swift_name("events")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EncounterRepository")))
@interface SharedEncounterRepository : SharedBase
- (instancetype)initWithTtlSeconds:(int64_t)ttlSeconds __attribute__((swift_name("init(ttlSeconds:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)shouldProcessIdHex:(NSString *)idHex nowSec:(int64_t)nowSec completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("shouldProcess(idHex:nowSec:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FakeServer")))
@interface SharedFakeServer : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)fakeServer __attribute__((swift_name("init()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResolvedEncounter")))
@interface SharedResolvedEncounter : SharedBase
- (instancetype)initWithName:(NSString *)name count:(int32_t)count idHex:(NSString *)idHex __attribute__((swift_name("init(name:count:idHex:)"))) __attribute__((objc_designated_initializer));
- (SharedResolvedEncounter *)doCopyName:(NSString *)name count:(int32_t)count idHex:(NSString *)idHex __attribute__((swift_name("doCopy(name:count:idHex:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithId:(NSString *)id displayName:(NSString *)displayName age:(SharedInt * _Nullable)age gender:(NSString * _Nullable)gender bio:(NSString * _Nullable)bio avatarUrl:(NSString * _Nullable)avatarUrl interests:(NSArray<NSString *> * _Nullable)interests rotatingId:(SharedKotlinByteArray * _Nullable)rotatingId __attribute__((swift_name("init(id:displayName:age:gender:bio:avatarUrl:interests:rotatingId:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedUserCompanion *companion __attribute__((swift_name("companion")));
- (SharedUser *)doCopyId:(NSString *)id displayName:(NSString *)displayName age:(SharedInt * _Nullable)age gender:(NSString * _Nullable)gender bio:(NSString * _Nullable)bio avatarUrl:(NSString * _Nullable)avatarUrl interests:(NSArray<NSString *> * _Nullable)interests rotatingId:(SharedKotlinByteArray * _Nullable)rotatingId __attribute__((swift_name("doCopy(id:displayName:age:gender:bio:avatarUrl:interests:rotatingId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property SharedInt * _Nullable age __attribute__((swift_name("age")));
...
@property NSArray<NSString *> * _Nullable interests __attribute__((swift_name("interests")));
@property SharedKotlinByteArray * _Nullable rotatingId __attribute__((swift_name("rotatingId")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserResolver")))
@interface SharedUserResolver : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
